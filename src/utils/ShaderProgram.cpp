...
void ShaderProgram::loadShaders(const char* vs_filename, const char* fs_filename)
{
	Shader vShader, fShader;

	vShader.initFromFile(VERTEX_SHADER, vs_filename);
	if (!vShader.isCompiled())
	{
		cout << "Vertex Shader Error" << endl;
		cout << "" << vShader.log() << endl << endl;
	}
	fShader.initFromFile(FRAGMENT_SHADER, fs_filename);
